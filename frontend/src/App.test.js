...
describe('App', () => {
  ...
  it('close the purchased invoice', async () => {
    fetch.mockResolvedValueOnce({
      json: () =>
        Promise.resolve({
          id: 2,
  ...
  it('should not approve the created invoice', async () => {
  });

  it('should not purchase the rejected invoice', async () => {
  });

  it('should purchase the approved invoice', async () => {
  });

  it('should reject the created invoice', async () => {
  });
